...
export default function RoadMap() {
  ...
  return (
    ...
    >
      ...
      >
        <div ref={headerRef} className="relative z-20 px-8 md:px-[10vw] shrink-0 flex flex-col lg:flex-row items-center justify-between gap-12 w-full">
          <div className="w-full lg:w-1/2 header-content">
            <div className="badge-anim inline-flex items-center gap-3 px-4 py-2 mb-8 rounded-full bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors cursor-default">
            ...
            <h2 className="title-anim text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white via-gray-200 to-gray-600 mb-8 cursor-default hover:scale-[1.02] hover:brightness-125 transition-all duration-300">
              The Journey
            </h2>

            <div className="flex flex-col gap-5 max-w-2xl relative">
              <div className="line-anim absolute -left-4 md:-left-6 top-1 bottom-1 w-[3px] bg-gradient-to-b from-emerald-500 via-blue-500 to-purple-600 rounded-full" />

              <p className="text-anim text-xl md:text-3xl text-gray-300 font-light leading-snug hover:text-white transition-colors duration-300">
              ...
              <p className="text-anim text-base md:text-lg text-gray-500 font-medium tracking-wide leading-relaxed">
              ...
              <div className="tags-container flex flex-wrap gap-3 mt-6">
                {["System Architecture", "Cloud & DevOps", "Platform Engineer"].map((tag, idx) => (
                  <span
                    key={idx}
                    className="tag-anim px-5 py-2.5 text-sm font-medium text-gray-300 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm cursor-pointer transition-all duration-300 shadow-lg shadow-black/20 hover:-translate-y-[5px] hover:scale-105 hover:bg-white/15 hover:border-white/30"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="image-content w-full lg:w-1/2 h-[400px] md:h-[600px] relative hidden lg:block overflow-hidden rounded-3xl">
            <ImageTrail
              items={[
        ...
        <div className={`relative w-full mt-12 md:mt-24 ${animationsEnabled ? 'overflow-hidden' : ''}`}>
          <div
            ...
            className={`relative z-10 flex items-center gap-6 md:gap-16 py-4 will-change-transform ${animationsEnabled
