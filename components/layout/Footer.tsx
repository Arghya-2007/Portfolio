      ...
      <div className="section-container flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <motion.a
            ...
            className="flex items-center justify-center w-[36px] h-[36px] rounded-full glass-subtle border-[rgba(42,157,143,0.12)] hover:border-[rgba(42,157,143,0.50)] transition-colors text-text-secondary hover:text-text-primary"
          >
