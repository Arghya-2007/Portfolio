...
export default function GithubGraph() {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="w-full bg-black/40 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-md mt-6 shadow-2xl relative overflow-hidden group"
      data-cursor="default"
    >
      ...
      <div className="relative z-10">
        ...
        <motion.div 
          ...
          className="overflow-x-auto pb-4 flex justify-start lg:justify-center relative scrollbar-hide"
        >
