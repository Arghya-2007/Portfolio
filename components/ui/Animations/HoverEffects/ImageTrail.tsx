...
export default function ImageTrail({ items = [], variant = 1 }: ImageTrailProps): JSX.Element {
  ...
  return (
    <div className="w-full h-full relative z-[100] rounded-lg bg-transparent overflow-visible group cursor-crosshair" ref={containerRef}>
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none transition-opacity duration-700 opacity-60 group-hover:opacity-10">
        <span className="text-4xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white/20 to-white/5 tracking-[0.2em] uppercase select-none text-center">
          Hover<br/>Me
        </span>
      </div>
