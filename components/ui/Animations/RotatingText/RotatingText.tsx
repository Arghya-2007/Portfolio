...
import { motion, AnimatePresence, type Transition, type TargetAndTransition, type VariantLabels, type HTMLMotionProps } from 'framer-motion';
...
export interface RotatingTextProps extends Omit<HTMLMotionProps<'span'>, 'transition' | 'initial' | 'animate' | 'exit'> {
  texts: string[];
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  const splitIntoCharacters = (text: string): string[] => {
    if (typeof Intl !== 'undefined' && 'Segmenter' in Intl) {
      ...
      const segmenter = new SegmenterConstructor('en', { granularity: 'grapheme' });
