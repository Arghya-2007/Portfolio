...
export type StrokeTextTrigger = 'mount' | 'hover' | 'scroll' | 'loop' | 'manual';
...
const StrokeText = ({
  ...
  useEffect(() => {
    ...
    if (trigger === 'hover') {
      ...
      root.addEventListener('pointerenter', playHover);
      removeHover = () => root.removeEventListener('pointerenter', playHover);
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse, play]);
